...
function Testimonials() {
  return ( 
    <div>
      <h2 className="text-2xl font-bold mb-4 ml-8 dark:text-white mt-10">What Our Patients Say</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4">
        <div className="h-96 bg-white dark:bg-slate-300 w-full md:w-96 shadow-lg mt-10 mx-auto">
          <img
          ...
          <p className='text-center text-slate-500 mt-3 font-serif text-lg dark:text-black '>Got consulted through fix health</p>
        </div>
        <div className="h-96 bg-white dark:bg-slate-300 w-full md:w-96 shadow-lg mt-10 mx-auto">
          <img
          ...
          <p className='text-center text-slate-500 mt-3 font-serif text-lg dark:text-black '>Book lab test through fix health</p>
        </div>
        <div className="h-96 bg-white dark:bg-slate-300 w-full md:w-96 shadow-lg mt-10 mx-auto">
          <img
          ...
          <p className='text-center text-slate-500 mt-3 font-serif text-lg dark:text-black  '>Ordered medicine through fix health</p>
        </div>
      </div>
    </div>
  );
